...
void loop() {
  ...
  float violet = calibratedValues[AS726x_VIOLET]/33000.00;
  float blue = calibratedValues[AS726x_BLUE]/38000.00;
  float green = calibratedValues[AS726x_GREEN]/15000.00;
  float yellow = calibratedValues[AS726x_YELLOW]/38000.00;
  float orange = calibratedValues[AS726x_ORANGE]/2300.00;
  float red = calibratedValues[AS726x_RED]/7400.00;
